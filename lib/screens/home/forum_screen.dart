...
class _ForumScreenState extends State<ForumScreen> {
  ...
  /// If the user isn't logged in, send them to LoginScreen first.
  /// Returns true once they're logged in (either already were, or
  /// just logged in / signed up successfully).
